...
const AnimatedSection: React.FC<{
  ...
  const [ref, isIntersecting] = useIntersectionObserver({
    threshold: 0.1,
    rootMargin: "0px", // Use 0px for more predictable triggering
  })
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white relative overflow-x-hidden">
      ...
      <section id="home" className="min-h-screen flex items-center pt-20">
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 min-h-[calc(100vh-80px)]">
          <AnimatedSection className="h-full min-h-[50vh] lg:min-h-full">
            <div className="relative h-full w-full">
              ...
              <Image src="/My Image.webp" alt="Kamau Johnson - Software Developer | Data Scientist" fill className="relative object-cover" priority sizes="(max-width: 1024px) 100vw, 50vw" />
            </div>
          </AnimatedSection>
      ...
      <section id="about" className="py-16 md:py-20 px-6 lg:px-8 relative" style={{ backgroundColor: "#F5F1EB" }}>
        <div className="max-w-6xl mx-auto">
          <AnimatedSection> <div className="text-left mb-8 md:mb-12"> <h2 className="text-3xl md:text-4xl font-bold text-gray-800">About Me</h2> </div> </AnimatedSection>
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <AnimatedSection delay={200} className="space-y-6">
              <div className="relative">
                ...
                <div className="space-y-4 text-gray-700 text-base leading-relaxed">
                  <p> A tech-savvy and driven Computer Science graduate passionate about building impactful software solutions. Now stepping confidently into Data Science, I leverage my problem-solving foundation to extract insights, build intelligent models, and innovate through data-powered technologies. </p>
                  <p> I'm an avid hackathon enthusiast and proudly won the Nairobi County Web3 and Blockchain Hackathon, where I led the development of a tokenized waste recycling system. </p>
                  <p> After earning a Diploma in Computer Science, I'm now pursuing my Bachelor's at the Catholic University of Eastern Africa. Internships at <a href="https://www.codsoft.in/internships" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline hover:text-blue-800 transition-colors" >Codsoft</a> and an attachment at <a href="https://acfc.co.ke/" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline hover:text-blue-800 transition-colors" >ACFC</a> have provided hands-on experience in data science and software development. </p>
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-blue-50 border-l-4 border-blue-600 p-4 rounded-r-lg hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group"> <Code className="w-6 h-6 text-blue-600 mb-2 transition-transform duration-300 group-hover:scale-110" /> <h4 className="font-semibold text-blue-600">Software Developer</h4> <p className="text-sm text-gray-600">Builder of Seamless Systems</p> </div>
                <div className="bg-green-50 border-l-4 border-green-600 p-4 rounded-r-lg hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group"> <Database className="w-6 h-6 text-green-600 mb-2 transition-transform duration-300 group-hover:scale-110" /> <h4 className="font-semibold text-green-600">Data Scientist</h4> <p className="text-sm text-gray-600">ML, analytics, predictive modeling</p> </div>
              </div>
              <p className="text-gray-700 leading-relaxed text-base"> I build modern, responsive web apps with HTML, CSS, JavaScript, Tailwind CSS, Next.js, and Python. For data science, I use Python libraries like Pandas, NumPy, and Scikit-learn. </p>
              <div className="pt-4">
            ...
            <AnimatedSection delay={400} className="space-y-6">
              ...
              <h3 className="text-xl font-semibold text-purple-600">Why I Love Tech</h3>
              <p className="text-gray-700 leading-relaxed text-base"> I believe technology is a catalyst for change. I'm driven by building meaningful solutions that solve, serve, and scale human potential through code. </p>
              <h3 className="text-xl font-semibold text-purple-600">Next Goal</h3>
              <p className="text-gray-700 leading-relaxed text-base"> I'm seeking internship opportunities and collaborative projects to apply my skills. My goal is to join a mission-driven tech team where I can grow into a full-stack developer and data scientist. </p>
              <Button onClick={() => scrollToSection("contact")} className="w-full bg-purple-600 hover:bg-purple-700 text-white transition-all duration-300 hover:shadow-lg hover:-translate-y-1 active:scale-95 py-3 group" > Let's Connect{" "} <ChevronRight className="w-4 h-4 ml-2 transition-transform duration-300 group-hover:translate-x-1" /> </Button>
            </AnimatedSection>
          </div>
        </div>
      </section>

      <section id="skills" className="py-16 md:py-20 px-6 lg:px-8 bg-black text-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
            <AnimatedSection className="lg:w-1/3 text-center lg:text-left">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">Skillset</h2>
              <p className="text-gray-400 text-lg leading-relaxed"> I architect complete, end-to-end solutions, turning your vision into a high-impact reality, from sleek interfaces to data-driven insights. </p>
            </AnimatedSection>
            <div className="lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
              {[ { iconPath: "/icons/Front-End-Development.gif", title: "Frontend Development", description: "I build modern, responsive, and intuitive user interfaces using React, Next.js, and Tailwind CSS.", }, { iconPath: "/icons/Backend-End-Developement.gif", title: "Backend Development", description: "I create robust, scalable backend systems and secure APIs for high-performance applications.", }, { iconPath: "/icons/Data Science and AI.gif", title: "Data Science & AI", description: "Leveraging Python, I develop machine learning models and perform data analysis to drive data-informed decisions.", }, { iconPath: "/icons/Tech Content Creator.gif", title: "Tech Content Creator", description: "I create tech content across platforms like YouTube to share my journey and educate others in tech.", }, ].map((area, index) => ( <AnimatedSection key={area.title} delay={index * 100} className="group text-center md:text-left"> <div className="mb-5 h-12 w-12 flex items-center justify-center mx-auto md:mx-0 transition-transform duration-300 group-hover:scale-110"> <Image src={area.iconPath || "/placeholder.svg"} alt={`${area.title} icon`} width={48} height={48} className="object-contain" unoptimized={true} /> </div> <h3 className="text-2xl font-bold text-white mb-3">{area.title}</h3> <p className="text-gray-400 text-base leading-relaxed">{area.description}</p> </AnimatedSection> ))}
            </div>
          </div>
          <AnimatedSection delay={600} className="mt-20 md:mt-28">
            <div className="text-center">
              <h3 className="text-3xl md:text-4xl font-bold text-white mb-4">Tech Stack</h3>
              <p className="text-gray-400 text-lg leading-relaxed max-w-3xl mx-auto mb-12"> My curated stack for crafting scalable systems and turning raw data into impactful solutions. </p>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-8 max-w-4xl mx-auto">
      ...
      <section id="projects" className="py-16 md:py-20 px-6 lg:px-8 bg-slate-800/30">
        <div className="max-w-6xl mx-auto">
          <AnimatedSection> <div className="text-center md:text-left mb-12 md:mb-16"> <h2 className="text-3xl lg:text-4xl font-bold mb-4"> Project <span className="text-purple-400">Highlights</span> </h2> <p className="text-lg text-gray-300 max-w-3xl mx-auto md:mx-0"> A curated collection of my software and data science projects, reflecting my commitment to building functional, user-focused solutions. </p> </div> </AnimatedSection>
          <AnimatedSection delay={200}> <div className="flex justify-center mb-12"> <div className="bg-slate-800/80 p-1 rounded-xl border border-slate-700 backdrop-blur-sm"> <Button onClick={() => setActiveProjectTab("all")} className={`px-4 sm:px-6 py-2 rounded-lg transition-all text-sm ${ activeProjectTab === "all" ? "bg-purple-600 text-white shadow-lg" : "bg-transparent text-gray-400 hover:text-white" }`} > All Projects </Button> </div> </div> </AnimatedSection>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {getFilteredProjects().map((project, index) => ( <AnimatedSection key={`${project.category}-${index}`} delay={index * 100}> <Card className="bg-slate-800/80 border-slate-700 hover:border-blue-600/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-blue-600/20 group backdrop-blur-sm overflow-hidden"> <CardContent className="p-0"> <div className="relative overflow-hidden"> <Image src={project.image || "/placeholder.svg"} alt={project.title} width={400} height={250} className="w-full h-48 object-cover transition-transform duration-300 group-hover:scale-110" /> <div className="absolute top-4 right-4"> <span className="bg-blue-600/90 backdrop-blur-sm text-white px-3 py-1 rounded-full text-xs font-semibold"> Dev </span> </div> </div> <div className="p-6"> <h3 className="text-xl font-semibold mb-3 group-hover:text-blue-400 transition-colors"> {project.title} </h3> <p className="text-gray-400 text-sm mb-4 leading-relaxed line-clamp-3">{project.description}</p> <div className="flex flex-wrap gap-2 mb-6"> {project.tech.slice(0, 3).map((tech) => ( <span key={tech} className="px-2 py-1 bg-blue-600/20 text-blue-400 text-xs rounded-full"> {tech} </span> ))} {project.tech.length > 3 && ( <span className="px-2 py-1 bg-gray-600/20 text-gray-400 text-xs rounded-full"> +{project.tech.length - 3} more </span> )} </div> <div className="flex space-x-3"> <Button size="sm" className="flex-1 bg-blue-600 hover:bg-blue-700 transition-all duration-300 hover:shadow-lg active:scale-95 text-xs group" onClick={() => handleProjectClick(project.id)} > <ExternalLink className="w-3 h-3 mr-1" /> View Details </Button> <Button size="sm" variant="outline" className="border-gray-600 text-white hover:bg-gray-800 bg-transparent transition-all duration-300 active:scale-95 group" onClick={() => window.open(project.githubUrl, "_blank")} > <Github className="w-3 h-3" /> </Button> </div> </div> </CardContent> </Card> </AnimatedSection> ))}
          </div>
          <AnimatedSection delay={800}> <div className="text-center mt-12"> <Button variant="outline" className="border-purple-600 text-purple-400 hover:bg-purple-600 hover:text-white px-8 py-3 bg-transparent transition-all duration-300 hover:shadow-lg hover:-translate-y-1 active:scale-95 group" onClick={() => window.open("https://github.com/Kamau-Johnson", "_blank")} > <Github className="w-4 h-4 mr-2" /> View All on GitHub </Button> </div> </AnimatedSection>
        </div>
      </section>

      <section id="achievements" className="py-16 md:py-20 px-6 lg:px-8 bg-slate-900">
        <div className="max-w-6xl mx-auto">
          <AnimatedSection> <div className="text-center md:text-left mb-12 md:mb-16"> <h2 className="text-3xl lg:text-4xl font-bold mb-4"> My <span className="text-purple-400">Achievements</span> </h2> <p className="text-lg text-gray-300 max-w-4xl mx-auto md:mx-0 leading-relaxed"> I'm an avid hackathon enthusiast, which has sharpened my skills and allowed me to collaborate and build impactful solutions. </p> </div> </AnimatedSection>
          <div className="space-y-12">
            <AnimatedSection delay={300}> <div className="bg-slate-800/30 p-6 md:p-8 rounded-2xl border border-slate-700 backdrop-blur-sm hover:border-purple-600/50 transition-all duration-300 group"> <h4 className="text-xl font-bold text-white mb-2">Power Hacks Hackathon - 4th Runners-Up</h4> <p className="text-purple-400 text-sm mb-3">October 2024 • First Hackathon Experience</p> <p className="text-gray-300 leading-relaxed"> Representing SOSTOS Blog, we developed an app to verify statement accuracy. I led full-stack development, and we secured 4th Runners-Up, fueling my passion for innovation. </p> </div> </AnimatedSection>
            <AnimatedSection delay={400}> <div className="bg-slate-800/30 p-6 md:p-8 rounded-2xl border border-slate-700 backdrop-blur-sm hover:border-purple-600/50 transition-all duration-300 group"> <h4 className="text-xl font-bold text-white mb-2">Blockchain & Web3 Bootcamp - 1st Runners-Up</h4> <p className="text-green-400 text-sm mb-3">April 2025 • $1000 Prize Winner</p> <p className="text-gray-300 leading-relaxed"> We developed BebaPay, a tokenized recycling platform on the Cypherium Blockchain. My role was designing the smart contract layer, earning us 1st Runners-Up and a $1000 prize. </p> </div> </AnimatedSection>
          </div>
          <div className="mt-16 space-y-8">
            <AnimatedSection delay={600}> <h3 className="text-2xl font-semibold text-center text-purple-400">Moments from the Journey</h3> </AnimatedSection>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <AnimatedSection delay={700}> <div className="relative group overflow-hidden rounded-xl border-2 border-slate-700"> <Image src="/BebaPay Hackathon.webp" alt="BebaPay Hackathon" width={800} height={600} className="w-full h-auto object-cover transition-transform duration-300 group-hover:scale-105" /></div> </AnimatedSection>
                <AnimatedSection delay={800}> <div className="relative group overflow-hidden rounded-xl border-2 border-slate-700"> <Image src="/Power Hacks Hackathon.webp" alt="Power Hacks Hackathon" width={600} height={400} className="w-full h-auto object-cover transition-transform duration-300 group-hover:scale-105" /></div> </AnimatedSection>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#f7e5fc] grid grid-cols-1 lg:grid-cols-2 gap-10" id="blog">
        <AnimatedSection className="p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
          <h1 className="text-4xl md:text-5xl font-bold text-black">Medium</h1>
          <p className="text-[#5b6876] mt-6 text-lg leading-relaxed"> I'm a technical writer documenting my journey in software and data science. My blog turns complex ideas into clear, relatable insights, sharing the decisions, challenges, and breakthroughs behind my work to educate and inspire others in tech. </p>
          <a href="https://medium.com/@Kamau_Johnson" target="_blank" rel="noopener noreferrer"> <button className="hover:bg-[#4c24dd] text-black py-3 mt-10 border-b-2 border-[#000] hover:px-6 transition-all duration-300 ease-in-out hover:text-white font-semibold"> Follow me on Medium </button> </a>
        </AnimatedSection>
        <AnimatedSection delay={300} className="hidden lg:flex items-center justify-center p-6">
      ...
      <section id="contact" className="py-16 md:py-20 px-6 lg:px-8 bg-slate-800/30">
        <div className="max-w-4xl mx-auto">
          <AnimatedSection> <div className="text-center md:text-left mb-12 md:mb-16"> <h2 className="text-3xl lg:text-4xl font-bold mb-4"> Let's Talk <span className="text-purple-400">Tech</span> </h2> <p className="text-lg text-gray-300">Have a project or question? Let's connect.</p> </div> </AnimatedSection>
          <div className="grid lg:grid-cols-2 gap-12">
            <AnimatedSection delay={200} className="space-y-8">
              <div>
                <h3 className="text-xl font-semibold text-purple-400 mb-6">Get in Touch</h3>
                <p className="text-gray-300 leading-relaxed text-base"> Big idea brewing? Let's bring it to life. Whether it's a high-impact website or a data-driven system, I'm all in. Reach out! </p>
              </div>
              <div className="space-y-4">
                <div className="flex items-center space-x-4 group"> <div className="w-12 h-12 bg-purple-600/20 rounded-lg flex items-center justify-center group-hover:bg-purple-600/30 transition-all duration-300"> <Mail className="w-5 h-5 text-purple-400" /> </div> <div> <p className="font-semibold">Email</p> <a href="mailto:johnsonkamau542@gmail.com" className="text-purple-400 hover:text-purple-300 transition-colors" > johnsonkamau542@gmail.com </a> </div> </div>
                <div className="flex items-center space-x-4 group"> <div className="w-12 h-12 bg-purple-600/20 rounded-lg flex items-center justify-center group-hover:bg-purple-600/30 transition-all duration-300"> <Phone className="w-5 h-5 text-purple-400" /> </div> <div> <p className="font-semibold">Phone</p> <a href="tel:+254768280952" className="text-purple-400 hover:text-purple-300 transition-colors" > +254 768280952 </a> </div> </div>
                <div className="flex items-center space-x-4 group"> <div className="w-12 h-12 bg-purple-600/20 rounded-lg flex items-center justify-center group-hover:bg-purple-600/30 transition-all duration-300"> <MapPin className="w-5 h-5 text-purple-400" /> </div> <div> <p className="font-semibold">Location</p> <p className="text-gray-300">Nairobi, Kenya</p> </div> </div>
              </div>
            </AnimatedSection>
              ...
              <Card className="bg-slate-800/80 border-slate-700 backdrop-blur-sm hover:border-purple-600/50 transition-all duration-300">
                <CardContent className="p-6 md:p-8">
                  ...
                  <form onSubmit={handleFormSubmit} className="space-y-6">
                    ...
                    {submitStatus === 'error' && ( <p className="text-red-400 text-center text-sm mt-4">Failed to send. Please try again or email me directly.</p> )}
                  </form>
                </CardContent>
              </Card>
            </AnimatedSection>
      ...
      <footer className="py-8 px-6 lg:px-8 border-t border-slate-800 bg-slate-800/50">
        <div className="max-w-6xl mx-auto">
      ...
      {showScrollTop && ( <Button onClick={scrollToTop} className="fixed bottom-6 right-6 bg-purple-600 hover:bg-purple-700 p-3 rounded-full shadow-lg transition-all duration-300 hover:-translate-y-1 active:scale-95 z-40 group" size="icon" > <Image src="/Scroll Cursor.gif" alt="Scroll to top" width={32} height={20} className="w-8 h-5 object-contain" unoptimized /> </Button> )}
    </div>
  )
}