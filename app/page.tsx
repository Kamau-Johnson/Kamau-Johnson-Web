// src/app/page.tsx (NO CHANGES WERE MADE TO THIS FILE)
    ...
    <div className="min-h-screen bg-slate-900 text-white relative overflow-x-hidden">
      ...
      <section id="about" className="py-16 md:py-20 px-4 sm:px-6 lg:px-8 relative" style={{ backgroundColor: "#F5F1EB" }}>
        <div className="max-w-6xl mx-auto">
          <AnimatedSection> <div className="text-center md:text-left mb-8 md:mb-12"> <h2 className="text-3xl md:text-4xl font-bold text-gray-800">About</h2> </div> </AnimatedSection>
      ...
      <section id="projects" className="py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-slate-800/30">
        <div className="max-w-6xl mx-auto">
          <AnimatedSection> <div className="text-center md:text-left mb-12 md:mb-16"> <h2 className="text-3xl lg:text-4xl font-bold mb-4"> Projects <span className="text-purple-400">Highlights</span> </h2> <p className="text-lg text-gray-300 max-w-3xl mx-auto md:mx-0"> Work that I've done for the past 2 years. This is a curated collection of my software development and data science projects. From intelligent web applications to data-driven platforms, each project reflects my commitment to building functional, user-focused, and scalable solutions using modern technologies. </p> </div> </AnimatedSection>
      ...
      <section id="achievements" className="py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-slate-900">
        <div className="max-w-6xl mx-auto">
          <AnimatedSection> <div className="text-center md:text-left mb-12 md:mb-16"> <h2 className="text-3xl lg:text-4xl font-bold mb-4"> My <span className="text-purple-400">Achievements</span> </h2> <p className="text-lg text-gray-300 max-w-4xl mx-auto md:mx-0 leading-relaxed"> I am an avid hackathon enthusiast and have proudly represented my work in various competitions. These events have not only sharpened my skills under pressure but have also allowed me to collaborate with brilliant minds and build impactful solutions. </p> </div> </AnimatedSection>
          <div className="space-y-12 mb-16">
            <AnimatedSection delay={200}> <h3 className="text-2xl font-semibold text-center md:text-left text-purple-400 mb-8">Track Record</h3> </AnimatedSection>
      ...
      <section id="contact" className="py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-slate-800/30">
        <div className="max-w-4xl mx-auto">
          <AnimatedSection> <div className="text-center md:text-left mb-12 md:mb-16"> <h2 className="text-3xl lg:text-4xl font-bold mb-4"> Let's Talk <span className="text-purple-400">Tech</span> </h2> <p className="text-lg text-gray-300">Tech in motion. Story in progress.</p> </div> </AnimatedSection>
